...
You can watch the video of the resulting performance of the controller [here.](https://github.com/jrapudg/CarND-PID-Control-Project/pid_video.mp4)
...
The strategy that I followed was, first by hand, I chose gains and saw how the system behaved. The values selected for P, I and D were -0.16, 0.0 and -2.5, respectively. Then, I used Twiddle to fine tune the controller. You can see the code of the Twiddle algorithm at the PID.cpp fro line 60 to 109.
